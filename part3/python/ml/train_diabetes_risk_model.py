...
FRAME_PATH = PROJECT_ROOT / "data" / "processed" / "brfss_training.parquet"
...
SUMMARY_PATH = PROJECT_ROOT / "docs" / "ml_model_summary.md"
...
def read_local_sql(query: str, columns: list[str]) -> pd.DataFrame:
    ...
    command = [
        ...
        "exec",
        "-e",
        f"SQLCMDPASSWORD={settings['MSSQL_SA_PASSWORD']}",
        LOCAL_CONTAINER,
        SQLCMD,
        "-C",
        "-S",
